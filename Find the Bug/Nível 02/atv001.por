...
programa
{
	...
	funcao inicio()
	{
		...
		se(mediaPonderada < 5){
			escreva("Sua nota final: ", mediaPonderada," ou seja você recebe um E")
		}
		senao se(mediaPonderada >= 5 e mediaPonderada < 6){
			escreva("Sua nota final: ", mediaPonderada," ou seja você recebe um D")
		}
		senao se(mediaPonderada >= 6 e mediaPonderada < 7){
			escreva("Sua nota final: ", mediaPonderada," ou seja você recebe um C")
		}
		senao se(mediaPonderada >= 7 e mediaPonderada < 8){
			escreva("Sua nota final: ", mediaPonderada," ou seja você recebe um B")
		}
		senao se(mediaPonderada > 8){
			escreva("Sua nota final: ", mediaPonderada," ou seja você recebe um A")
		}
	}
}
/* $$$ Portugol Studio $$$ 
